...
import { NotFoundError, WorkoutPlanNotActiveError, SessionAlreadyStartedError } from "../errors/index.js";
import { auth } from "../lib/auth.js";
import { ErrorSchema, WorkoutPlanSchema, StartWorkoutSessionParamsSchema, StartWorkoutSessionResponseSchema, UpdateWorkoutSessionParamsSchema, UpdateWorkoutSessionBodySchema, UpdateWorkoutSessionResponseSchema, GetWorkoutPlanParamsSchema, GetWorkoutPlanResponseSchema, GetWorkoutDayParamsSchema, GetWorkoutDayResponseSchema, ListWorkoutPlansQuerySchema, ListWorkoutPlansResponseSchema } from "../schemas/index.js";
...
export const wourkoutPlanRoutes = async (app: FastifyInstance) => {
